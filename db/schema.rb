...
ActiveRecord::Schema[8.1].define(version: 2026_09_01_063246) do
  ...
  create_table "chat_room_pins", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["chat_room_id"], name: "index_chat_room_pins_on_chat_room_id"
    t.index ["user_id", "chat_room_id"], name: "index_chat_room_pins_on_user_id_and_chat_room_id", unique: true
    t.index ["user_id"], name: "index_chat_room_pins_on_user_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "name"
    t.string "phone"
    t.string "preferred_language", default: "he"
    t.datetime "remember_created_at"
    t.datetime "reset_password_sent_at"
    t.string "reset_password_token"
    t.integer "role"
